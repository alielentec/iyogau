    ...
    en: {
      natal: {
        ...
        form: {
          ...
          inputEyebrow: 'Calculation input',
          inputSummary: 'Active birth data for chart calculations.',
          profileEyebrow: 'Profile library',
        ...
        astrocarto: {
          ...
          errorSignedOut: 'Sign in to select a saved birth profile and calculate this private map.',
        ...
        results: {
          ...
          signedOutEmpty: 'Sign in to select a saved birth profile and calculate private chart results.',
    ...
    ko: {
      natal: {
        ...
        form: {
          heading: '출생 정보',
          inputEyebrow: '계산 입력',
          inputSummary: '차트 계산에 사용할 현재 출생 정보입니다.',
          profileEyebrow: '프로필 보관함',
        ...
        astrocarto: {
          ...
          errorSignedOut: '저장된 출생 프로필을 선택하고 이 개인 지도를 계산하려면 로그인해 주세요.',
        ...
        results: {
          ...
          signedOutEmpty: '저장된 출생 프로필을 선택하고 개인 차트 결과를 계산하려면 로그인해 주세요.',
    ...
    zh: {
      natal: {
        ...
        astrocarto: {
          ...
          errorSignedOut: '请登录后选择已保存的出生档案并计算此私人地图。',
        ...
        results: {
          ...
          signedOutEmpty: '请登录后选择已保存的出生档案并计算私人星盘结果。',
