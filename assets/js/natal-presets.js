 ...
 *
 *  Ordering: Ali is FIRST and is the public default calibration chart.
 *  Remaining public figures render as compact cards when publicCard is true.
 *  Images are local-only optional assets; missing files fall back to initials.
 * ===================================================================== */
  ...
  var PRESETS = [
    {
      ...
      imageAlt: '',
      publicCard: true,
      source: 'User-provided Google Sheet Bday tab: 9-Jun-85, 15:30:30, GMT+03:30, 48 E 41′ 52″, 35 N 11′ 49″',
